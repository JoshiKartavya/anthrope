...
const Footer = () => {
  return (
    <div className='footer w-screen h-[50vh] lg:h-[70vh] bg-[--secondary] mt-12 py-10 overflow-y-hidden'>
      ...
      <div className="links px-6 h-full md:h-[60%] lg:px-12 lg:h-[40%] flex flex-col sm:flex-col md:flex-col lg:flex-row justify-between items-center lg:items-end">
        ...
        <div className="socials overflow-y-hidden flex flex-row gap-2 lg:gap-8">
          <a href="#"><i className="ri-twitter-x-line text-[--primary] overflow-y-hidden text-2xl md:text-4xl lg:text-5xl"></i></a>
          <a href="#"><i className="ri-instagram-fill text-[--primary] overflow-y-hidden text-2xl md:text-4xl lg:text-5xl"></i></a>
          <a href="#"><i className="ri-youtube-fill text-[--primary] overflow-y-hidden text-2xl md:text-4xl lg:text-5xl"></i></a>
          <a href="#"><i className="ri-facebook-fill text-[--primary] overflow-y-hidden text-2xl md:text-4xl lg:text-5xl"></i></a>
        </div>

        <div className="right w-full lg:w-[35%]">
          <h1 className='text-[--primary] overflow-y-hidden text-lg md:text-2xl lg:text-3xl font-medium text-center lg:text-end capitalize'>the content of this site is copyright-protected and is property of Anthrope group</h1>
        </div>
      </div>

      <div className="watermark w-screen ">
        <h1 className='text-[#474747] text-center bottom-0 lg:bottom-2 sm: text-[4rem] md:text-[8rem] lg:text-[16rem] font-black overflow-y-hidden'>ANTHROPE</h1>
      </div>
    </div>
  )
}
