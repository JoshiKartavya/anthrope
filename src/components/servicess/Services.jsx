...
const Services = () => {
  return (
    <div className="h-[130vh] w-screen  overflow-x-hidden">
      ...
      <div className="services-main h-full lg:h-screen w-screen flex flex-col gap-8">
        ...
        <div className="content flex flex-col lg:flex-row">
          <div className="left h-[80vh] flex flex-col justify-center items-center gap-12 w-full lg:w-1/2 pl-8 lg:pl-28">
          ...
          <div className="right w-full lg:w-1/2 h-[60vh] lg:h-[80vh] ">
              <div className="container flex items-center justify-end relative">
                <div className="img-1 relative w-[380px] h-[300px] lg:w-[550px] lg:h-[650px]">
