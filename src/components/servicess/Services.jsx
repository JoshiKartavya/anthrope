      ...
      <div className="services-main h-full lg:h-screen w-screen flex flex-col gap-0 lg:gap-8">
        ...
        <div className="content flex flex-col lg:flex-row">
          <div className="left h-auto lg:h-[80vh] flex flex-col justify-center items-center gap-12 w-[90%] lg:w-1/2 pl-8 lg:pl-28 pb-12 lg:pb-0">
            ...
            <div className="serv text-[--secondary] flex flex-col gap-2 bg-transparent">
              <h2 className="text-[--primary] bg-[--secondary] w-8 h-8 lg:w-12 lg:h-12 flex flex-col justify-center items-center text-center text-xl lg:text-3xl rounded-full">2</h2>
              <h1 className="text-xl lg:text-4xl">Low price with Best Quality</h1>
              <p className="text-sm lg:text-2xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis et natus ipsa reiciendis quia ad sunt?</p>
            </div>

            <div className="serv text-[--secondary] flex flex-col gap-2 bg-transparent">
              <h2 className="text-[--primary] bg-[--secondary] w-8 h-8 lg:w-12 lg:h-12 flex flex-col justify-center items-center text-center text-xl lg:text-3xl rounded-full">3</h2>
              <h1 className="text-xl lg:text-4xl">Resturant Services</h1>
              <p className="text-sm lg:text-2xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis et natus ipsa reiciendis quia ad sunt?</p>
            </div>
          </div>
          <div className="right w-full lg:w-1/2 h-[60vh] lg:h-[80vh] mt-8 lg:mt-0">
